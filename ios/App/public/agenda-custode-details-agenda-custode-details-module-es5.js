(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["agenda-custode-details-agenda-custode-details-module"], {
    ...
    function GcV(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "AgendaCustodeDetailsPageModule", function () {
        return AgendaCustodeDetailsPageModule;
      });
      /* harmony import */
      ...
      var _agenda_custode_details_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./agenda-custode-details-routing.module */
      "N6sY");
      /* harmony import */


      var _agenda_custode_details_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./agenda-custode-details.page */
      "Abau");
      /* harmony import */
      ...
      var AgendaCustodeDetailsPageModule = function AgendaCustodeDetailsPageModule() {
        _classCallCheck(this, AgendaCustodeDetailsPageModule);
      };

      AgendaCustodeDetailsPageModule.ɵfac = function AgendaCustodeDetailsPageModule_Factory(t) {
        return new (t || AgendaCustodeDetailsPageModule)();
      };

      AgendaCustodeDetailsPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineNgModule"]({
        type: AgendaCustodeDetailsPageModule
      });
      AgendaCustodeDetailsPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _agenda_custode_details_routing_module__WEBPACK_IMPORTED_MODULE_3__["AgendaCustodeDetailsPageRoutingModule"], src_app_shared_components_shared_components_module__WEBPACK_IMPORTED_MODULE_5__["SharedComponentsModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵsetNgModuleScope"](AgendaCustodeDetailsPageModule, {
          declarations: [_agenda_custode_details_page__WEBPACK_IMPORTED_MODULE_4__["AgendaCustodeDetailsPage"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _agenda_custode_details_routing_module__WEBPACK_IMPORTED_MODULE_3__["AgendaCustodeDetailsPageRoutingModule"], src_app_shared_components_shared_components_module__WEBPACK_IMPORTED_MODULE_5__["SharedComponentsModule"]]
        });
      })();
      /***/
    ...
    /***/
    function Abau(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AgendaCustodeDetailsPage", function () {
        return AgendaCustodeDetailsPage;
      });
      /* harmony import */
      ...
      var src_app_models_prenotazionepianificazione_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var _shared_components_player_number_player_number_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../shared/components/player-number/player-number.component */
      "JI/N");
      /* harmony import */


      var _shared_components_alert_input_prezzo_alert_input_prezzo_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../../shared/components/alert-input-prezzo/alert-input-prezzo.component */
      "31Zp");

      function AgendaCustodeDetailsPage_app_alert_input_prezzo_0_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("onDismiss", function AgendaCustodeDetailsPage_app_alert_input_prezzo_0_Template_app_alert_input_prezzo_onDismiss_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r3);

            var ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]();

            return ctx_r2.dismissInputPrezzo($event);
          });
      ...
      function AgendaCustodeDetailsPage_ion_chip_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var AgendaCustodeDetailsPage = /*#__PURE__*/function () {
        function AgendaCustodeDetailsPage(activatedRoute, navController, startService, loadingController, toastController, alertController) {
          _classCallCheck(this, AgendaCustodeDetailsPage);
        ...
        _createClass(AgendaCustodeDetailsPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this = this;

            this.subParaMap = this.activatedRoute.paramMap.subscribe(function (route) {
              if (route.has('idPianificazione')) {
                _this.selectedIdPianificazione = route.get('idPianificazione');

                _this.updateOccupazione(_this.selectedIdPianificazione);
              } else {
          ...
          key: "updateOccupazione",
          value: function updateOccupazione(id) {
            var _this2 = this;
            ...
            this.loadingController.create({
              ...
              return _this2.startService.requestOccupazioneById(id, true);
            }).then(function (elOccupazione) {
              _this2.loadingController.dismiss();

              _this2.myOccupazione = elOccupazione; //@ts-ignore

              _this2.myPrenotazione = elOccupazione.getDocInRepository(elOccupazione.IDREF);
              _this2.myPianificazione = _this2.myPrenotazione.getPianificazione(_this2.myOccupazione.ID);
              _this2.myPianificazione._INCASSOCUSTODE = _this2.myPianificazione.RESIDUO;
              console.log(_this2.myOccupazione);
              console.log(_this2.myPrenotazione);
              console.log(_this2.myPianificazione);
          ...
          key: "onClickConferma",
          value: function onClickConferma() {
            var _this3 = this;
          ...
          value: function onChangedNumPlayer(nPlayer) {
            ...
            this.myPianificazione.NUMPARTECIPANTI = nPlayer; // this.calcolaTotale();
          }
        }, {
          key: "showInputPrezzo",
          value: function showInputPrezzo() {
            this._showInputPrezzo = true;
          }
        }, {
          key: "dismissInputPrezzo",
          value: function dismissInputPrezzo(value) {
            if (value) {
      ...
      AgendaCustodeDetailsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        ...
        template: function AgendaCustodeDetailsPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("changeNumPlayer", function AgendaCustodeDetailsPage_Template_app_player_number_changeNumPlayer_50_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AgendaCustodeDetailsPage_Template_ion_card_click_78_listener() {
              return ctx.showInputPrezzo();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AgendaCustodeDetailsPage_Template_ion_button_click_87_listener() {
              return ctx.onClickConferma();
            });
    ...
    /***/
    function N6sY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AgendaCustodeDetailsPageRoutingModule", function () {
        return AgendaCustodeDetailsPageRoutingModule;
      });
      /* harmony import */
      ...
      var _agenda_custode_details_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./agenda-custode-details.page */
      "Abau");
      /* harmony import */
      ...
      var AgendaCustodeDetailsPageRoutingModule = function AgendaCustodeDetailsPageRoutingModule() {
        _classCallCheck(this, AgendaCustodeDetailsPageRoutingModule);
      };

      AgendaCustodeDetailsPageRoutingModule.ɵfac = function AgendaCustodeDetailsPageRoutingModule_Factory(t) {
        return new (t || AgendaCustodeDetailsPageRoutingModule)();
      };

      AgendaCustodeDetailsPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: AgendaCustodeDetailsPageRoutingModule
      });
      AgendaCustodeDetailsPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AgendaCustodeDetailsPageRoutingModule, {
...
//# sourceMappingURL=agenda-custode-details-agenda-custode-details-module-es5.js.map