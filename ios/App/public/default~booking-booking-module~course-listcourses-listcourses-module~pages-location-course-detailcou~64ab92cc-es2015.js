...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PaymentProcess", function() { return PaymentProcess; });
...
class PaymentProcess {
    constructor(myModePayment) {
        ...
        if (myModePayment == _valuelist_model__WEBPACK_IMPORTED_MODULE_0__["PaymentMode"].pagaStruttura) {
            this.channelPayment = _valuelist_model__WEBPACK_IMPORTED_MODULE_0__["PaymentChannel"].onSite;
            ...
            this.channelPayment = _valuelist_model__WEBPACK_IMPORTED_MODULE_0__["PaymentChannel"].bonifico;
            //Processo di pagamento concluso
            this.processResult = true;
        }
    }
...
/* harmony import */ var src_app_models_payment_process_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/models/payment-process.model */ "plgS");
...
function PaymentPage_div_18_Template(rf, ctx) { if (rf & 1) {
...
class PaymentPage {
     ...
     */
    onSuccessPayment(channel, idTransaction) {
    ...
    renderPayPalBtn(payPalSettings) {
        let _this = this;
        if (this.paypalVersion == 'checkout') {
...
PaymentPage.ɵfac = function PaymentPage_Factory(t) { return new (t || PaymentPage)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_0__["ModalController"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_0__["ToastController"])); };
PaymentPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: PaymentPage, selectors: [["app-payment"]], inputs: { paymentData: "paymentData", listAreaPaymentSettings: "listAreaPaymentSettings" }, decls: 19, vars: 7, consts: [["color", "primary"], ["slot", "primary"], [3, "click"], ["slot", "icon-only", "ios", "close", "md", "close"], ["color", "danger", "expand", "block", 1, "full-buttons", 3, "click"], [4, "ngIf"], [1, "cart-total"], ["lines", "none"], ["slot", "end", 1, "ion-text-right"], ["class", "cart-items", 4, "ngIf"], ["mode", "ios"], ["type", "indeterminate"], [1, "cart-items"], ["id", "customBtnPaypal"]], template: function PaymentPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function PaymentPage_Template_ion_button_click_3_listener() { return ctx.onCancelPayment(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function PaymentPage_Template_ion_button_click_8_listener() { return ctx.onCancelPayment(); });
