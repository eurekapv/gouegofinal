...
/* harmony import */ var src_app_models_pianificazionecorso_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/models/pianificazionecorso.model */ "b5Gy");
/* harmony import */ var src_app_library_services_docstructure_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/library/services/docstructure.service */ "FYk8");
/* harmony import */ var src_app_library_models_requestParams_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/library/models/requestParams.model */ "R2Z1");
...
function CalendarPage_ion_list_12_ion_item_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const giornata_r3 = ctx.$implicit;
...
function CalendarPage_ion_list_12_Template(rf, ctx) { if (rf & 1) {
...
function CalendarPage_div_13_Template(rf, ctx) { if (rf & 1) {
...
class CalendarPage {
    constructor(mdlController, docStructureService, loadingController, toastController) {
    ...
    ngOnInit() {
        ...
        let filter = new src_app_models_pianificazionecorso_model__WEBPACK_IMPORTED_MODULE_2__["PianificazioneCorso"](true);
        filter.IDCORSO = this.myCorso.ID;
        //creo i parametri per la richiesta
        let params = new src_app_library_models_requestParams_model__WEBPACK_IMPORTED_MODULE_4__["RequestParams"]();
...
CalendarPage.ɵfac = function CalendarPage_Factory(t) { return new (t || CalendarPage)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](src_app_library_services_docstructure_service__WEBPACK_IMPORTED_MODULE_3__["DocstructureService"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["LoadingController"]), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ToastController"])); };
CalendarPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({ type: CalendarPage, selectors: [["app-calendar"]], inputs: { myCorso: "myCorso" }, decls: 14, vars: 5, consts: [[1, "ion-no-border"], ["color", "primary"], ["slot", "start"], ["name", "calendar"], ["slot", "end"], [3, "click"], ["name", "close"], ["class", "ion-no-padding", "id", "cal-find", 4, "ngIf"], ["class", "nofind-cnt", 4, "ngIf"], ["id", "cal-find", 1, "ion-no-padding"], ["class", "ion-no-padding ion-no-margin", "color", "light", 4, "ngFor", "ngForOf"], ["color", "light", 1, "ion-no-padding", "ion-no-margin"], ["size", "4", 1, "colGiorno"], [1, "contentGiorno", "ion-no-padding"], ["size", "8", 1, "colOrario"], ["mode", "ios", 1, "ion-no-margin", "ion-no-padding"], [1, "ion-no-margin", "ion-no-padding"], [1, "ion-no-margin"], ["lines", "none", 3, "color"], ["name", "play", "slot", "start"], ["lines", "none"], ["name", "pause", "slot", "start"], ["slot", "end", 3, "color"], [1, "nofind-cnt"]], template: function CalendarPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function CalendarPage_Template_ion_button_click_9_listener() { return ctx.closeCalendar(); });
