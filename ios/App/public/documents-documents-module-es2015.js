...
/* harmony import */ var _documents_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./documents.page */ "r9WI");
...
DocumentsPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({ type: DocumentsPageRoutingModule });
DocumentsPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](DocumentsPageRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] }); })();
...
/* harmony import */ var _ionic_native_chooser_ngx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic-native/chooser/ngx */ "UWV4");
/* harmony import */ var src_app_shared_components_shared_components_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/components/shared-components.module */ "jgPy");
/* harmony import */ var _documents_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./documents-routing.module */ "EZvh");
/* harmony import */ var _documents_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./documents.page */ "r9WI");
...
DocumentsPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineNgModule"]({ type: DocumentsPageModule });
DocumentsPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineInjector"]({ providers: [_ionic_native_chooser_ngx__WEBPACK_IMPORTED_MODULE_3__["Chooser"]], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵsetNgModuleScope"](DocumentsPageModule, { declarations: [_documents_page__WEBPACK_IMPORTED_MODULE_6__["DocumentsPage"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"],
        _documents_routing_module__WEBPACK_IMPORTED_MODULE_5__["DocumentsPageRoutingModule"],
        src_app_shared_components_shared_components_module__WEBPACK_IMPORTED_MODULE_4__["SharedComponentsModule"]] }); })();
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "TEn/");
/* harmony import */ var src_app_shared_components_upload_upload_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/components/upload/upload.component */ "omi/");
/* harmony import */ var src_app_models_tipodocumentazione_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/models/tipodocumentazione.model */ "ci2e");
/* harmony import */ var src_app_library_models_requestParams_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/library/models/requestParams.model */ "R2Z1");
/* harmony import */ var src_app_library_models_iddocument_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/library/models/iddocument.model */ "5usX");
...
/* harmony import */ var src_app_models_utente_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/models/utente.model */ "AN5U");
/* harmony import */ var src_app_library_models_postResult_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/library/models/postResult.model */ "uNYz");
/* harmony import */ var _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/file/ngx */ "FAH8");
/* harmony import */ var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/file-opener/ngx */ "te5A");
/* harmony import */ var src_app_services_file_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/services/file.service */ "cpn4");
...
function DocumentsPage_ion_buttons_6_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("click", function DocumentsPage_ion_buttons_6_Template_ion_button_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵrestoreView"](_r4); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](); return ctx_r3.onAddDocument(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelement"](2, "ion-icon", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementEnd"]();
} }
function DocumentsPage_div_10_Template(rf, ctx) { if (rf & 1) {
...
function DocumentsPage_div_11_ion_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("click", function DocumentsPage_div_11_ion_item_2_Template_ion_item_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵrestoreView"](_r8); const documento_r6 = ctx.$implicit; const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](2); return ctx_r7.onClickElement(documento_r6); });
...
function DocumentsPage_div_11_Template(rf, ctx) { if (rf & 1) {
...
class DocumentsPage {
    constructor(startService, chooser, toastController, modalController, docStructureService, loadingController, platform, file, fileOpener, fileService) {
     ...
     */
    requestListaDocumenti(event) {
        let reqParams = new src_app_library_models_requestParams_model__WEBPACK_IMPORTED_MODULE_5__["RequestParams"]();
    ...
    requestTipiDocumento() {
        ...
        let filter = new src_app_models_tipodocumentazione_model__WEBPACK_IMPORTED_MODULE_4__["TipoDocumentazione"](true);
        filter.ZORDER = 0;
        filter.addFilterCondition(src_app_library_models_iddocument_model__WEBPACK_IMPORTED_MODULE_6__["OperatorCondition"].maggiore, 'ZORDER');
        //Faccio la richiesta
    ...
    onAddDocument() {
        this.modalController.create({
            ...
            elModal.onWillDismiss()
                ...
                let docUploadDocumentazione = data['data'];
     ...
     */
    requestUploadToServer(docUploadDocumentazione) {
        ...
        if (docUploadDocumentazione) {
            this.loadingController.create({
                ...
                let fakeUtente = new src_app_models_utente_model__WEBPACK_IMPORTED_MODULE_8__["Utente"]();
                ...
                let paramExport = new src_app_library_models_iddocument_model__WEBPACK_IMPORTED_MODULE_6__["ParamsExport"]();
                ...
                //Qui Creo il JSON
                let myJson = docUploadDocumentazione.exportToJSON(paramExport);
                //ora che ho tutto, faccio la post
                this.docStructureService.requestForFunction(fakeUtente, 'uploadDocumentazione', myJson)
                    .then(rawResponse => {
                    elLoading.dismiss();
                    //Risposta ricevuta
                    let myResponse = new src_app_library_models_postResult_model__WEBPACK_IMPORTED_MODULE_9__["PostResponse"]();
...
DocumentsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({ type: DocumentsPage, selectors: [["app-documents"]], decls: 12, vars: 3, consts: [["color", "primary"], ["slot", "start"], ["defaultHref", "/account"], ["slot", "end", 4, "ngIf"], ["slot", "fixed", 3, "ionRefresh"], ["class", "nofind-cnt", 4, "ngIf"], [4, "ngIf"], ["slot", "end"], [3, "click"], ["name", "add"], [1, "nofind-cnt"], [3, "click", 4, "ngFor", "ngForOf"], ["slot", "start", "color", "", "name", "document-text-outline", 1, "icon-left"], ["slot", "end", "color", "primary", "name", "cloud-download-outline"]], template: function DocumentsPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("ionRefresh", function DocumentsPage_Template_ion_refresher_ionRefresh_8_listener($event) { return ctx.requestListaDocumenti($event); });
