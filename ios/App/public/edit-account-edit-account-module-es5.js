(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["edit-account-edit-account-module"], {
    ...
    function YfV(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_library_models_mydatetime_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/library/models/mydatetime.model */
      "K4nM");
      /* harmony import */


      var src_app_pages_auth_verify_verify_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/pages/auth/verify/verify.page */
      "9F3y");
      /* harmony import */


      var src_app_models_gruppo_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      function EditAccountPage_ion_select_option_29_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditAccountPage_ion_item_72_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditAccountPage_ion_item_87_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function EditAccountPage_ion_item_87_Template_ion_item_click_0_listener() {
      ...
      function EditAccountPage_ion_item_88_Template(rf, ctx) {
        if (rf & 1) {
          var _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "ion-item", 33);

          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function EditAccountPage_ion_item_88_Template_ion_item_click_0_listener() {
      ...
      function EditAccountPage_ion_item_89_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "ion-item");
      ...
      function EditAccountPage_ion_item_90_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "ion-item");
      ...
      var EditAccountPage = /*#__PURE__*/function () {
        function EditAccountPage(startService, navCtr, toastCtr, loadingController, modalController) {
          var _this = this;
          ...
          this.utenteListen = this.startService.utente.subscribe(function (data) {
            //Recupero l'utente
            _this.utente = data;

            if (_this.utente.MOBILENUMBER == null) {
              _this.utente.MOBILENUMBER = '';
            }
        ...
        _createClass(EditAccountPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.docGruppo = this.startService.actualStartConfig.gruppo; //this.createForm();
          }
        }, {
          key: "ngOnDestroy",
          ...
          value: function createForm() {
            var patternCodice = '^[A-Za-z]{6}[0-9]{2}[A-Za-z]{1}[0-9]{2}[A-Za-z]{1}[0-9]{3}[A-Za-z]{1}';
            ...
            if (!this.docGruppo.needMobileVerify) {
              ...
              var mobile = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControl"](this.utente.MOBILENUMBER, {
                updateOn: 'change',
            ...
            if (!this.docGruppo.needEmailVerify) {
              ...
              var email = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControl"](this.utente.EMAIL, {
                updateOn: 'change',
          ...
          value: function onSubmit() {
            ...
            if (this.form.valid) {
              ...
              this.utente.NATOISOSTATO = this.form.value.statoNascita; //EMAIL E NUMERO DI TELEFONO LI MODIFICO SOLO SE NON DEVONO ESSERE VERIFICATI, ALTRIMENTI VERRA' CHIAMATA LA VIDEATA APPOSITA
              ...
              console.log('mando');
              console.log(this.utente); //USO IL LOADING CONTROLLER 
              ...
              this.loadingController.create({
                ...
                _this2.startService.updateUtente(_this2.utente).then(function (result) {
                  // Operazione effettuata
                  elLoading.dismiss(); //Aggiornamento corretto

                  _this2.showMessage('Info Aggiornate');
          ...
          value: function onCfChange() {
            ...
            var codFiscString = this.form.value.cf;
            ...
            if (codFiscString != null && codFiscString != undefined) {
              if (codFiscString.length != 0) {
                ...
                this.startService.checkCodiceFiscale(codFiscString, true).then(function (codFiscObj) {
                  ...
                  _this3.utente.NATOISOSTATO = 'Italia';
                  _this3.utente.NATOA = codFiscObj.comune;
                  _this3.utente.NATOPROV = codFiscObj.provincia;
                  _this3.utente.NATOIL = codFiscObj.dataNascita;
                  _this3.utente.SESSO = codFiscObj.sesso;
                  _this3.utente.NATOCAP = codFiscObj.cap; //aggiorno i campi del form

                  _this3.form.get('comNascita').setValue(_this3.utente.NATOA);

                  _this3.form.get('provNascita').setValue(_this3.utente.NATOPROV);

                  _this3.form.get('nascita').setValue(_this3.utente.NATOIL.toISOString());

                  _this3.form.get('sesso').setValue(_this3.utente.SESSO);

                  _this3.form.get('statoNascita').setValue(_this3.utente.NATOISOSTATO);

                  _this3.form.get('capNascita').setValue(_this3.utente.NATOCAP); //setto il campo cf come valido


                  _this3.form.controls['cf'].setErrors(null);
                })["catch"](function (err) {
                  //qui in teoria il cf non ha passato neppure il check base, segno il campo come non valido
                  _this3.form.controls['cf'].setErrors({
                    'incorrect': true
                  });
      ...
      EditAccountPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
        ...
        template: function EditAccountPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function EditAccountPage_Template_ion_button_click_5_listener() {
              return ctx.onSubmit();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("ionBlur", function EditAccountPage_Template_ion_input_ionBlur_33_listener() {
              return ctx.onCfChange();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function EditAccountPage_Template_ion_button_click_92_listener() {
              return ctx.onSubmit();
            });
    ...
    /***/
    function ePbb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _edit_account_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./edit-account-routing.module */
      "ee1P");
      /* harmony import */


      var _edit_account_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./edit-account.page */
      "Yf+V");
      /* harmony import */
      ...
      EditAccountPageModule.ɵfac = function EditAccountPageModule_Factory(t) {
        return new (t || EditAccountPageModule)();
      };

      EditAccountPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineNgModule"]({
        type: EditAccountPageModule
      });
      EditAccountPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _edit_account_routing_module__WEBPACK_IMPORTED_MODULE_4__["EditAccountPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"], src_app_pages_auth_verify_verify_module__WEBPACK_IMPORTED_MODULE_2__["VerifyPageModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵsetNgModuleScope"](EditAccountPageModule, {
    ...
    /***/
    function ee1P(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _edit_account_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./edit-account.page */
      "Yf+V");
      /* harmony import */
      ...
      EditAccountPageRoutingModule.ɵfac = function EditAccountPageRoutingModule_Factory(t) {
        return new (t || EditAccountPageRoutingModule)();
      };

      EditAccountPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: EditAccountPageRoutingModule
      });
      EditAccountPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](EditAccountPageRoutingModule, {
