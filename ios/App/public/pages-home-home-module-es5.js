(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-home-home-module"], {
    ...
    function Un(module, __webpack_exports__, __webpack_require__) {
      ...
      var _auth_new_login_new_login_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../auth/new-login/new-login.module */
      "S8DX");
      /* harmony import */


      var _newsdetail_newsdetail_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _auth_psw_recovery_psw_recovery_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../auth/psw-recovery/psw-recovery.module */
      "Fdjd");
      /* harmony import */
      ...
      var _history_historycourse_allegatilist_allegatilist_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../history/historycourse/allegatilist/allegatilist.module */
      "QKPD");
      /* harmony import */
      ...
      HomePageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineNgModule"]({
        type: HomePageModule
      });
      HomePageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_5__["HomePageRoutingModule"], _newsdetail_newsdetail_module__WEBPACK_IMPORTED_MODULE_4__["NewsdetailPageModule"], _auth_new_login_new_login_module__WEBPACK_IMPORTED_MODULE_3__["NewLoginPageModule"], _auth_psw_recovery_psw_recovery_module__WEBPACK_IMPORTED_MODULE_6__["PswRecoveryPageModule"], _shared_components_shared_components_module__WEBPACK_IMPORTED_MODULE_7__["SharedComponentsModule"], _history_historycourse_allegatilist_allegatilist_module__WEBPACK_IMPORTED_MODULE_8__["AllegatilistPageModule"] // RouterModule.forChild([
        //   {
        //     path: '',
        //     component: HomePage
        //   }
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵsetNgModuleScope"](HomePageModule, {
    ...
    function hsj(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_models_impegno_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var src_app_models_buttoncard_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/models/buttoncard.model */
      "07+x");
      /* harmony import */


      var src_app_models_newsevento_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/models/newsevento.model */
      "h27B");
      /* harmony import */


      var src_app_pages_auth_new_login_new_login_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/pages/auth/new-login/new-login.page */
      "uVj7");
      /* harmony import */


      var src_app_pages_newsdetail_newsdetail_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/pages/newsdetail/newsdetail.page */
      "FYlm");
      /* harmony import */


      var src_app_library_services_docstructure_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/library/services/docstructure.service */
      "FYk8");
      /* harmony import */


      var src_app_library_models_requestParams_model__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! src/app/library/models/requestParams.model */
      "R2Z1");
      /* harmony import */


      var src_app_library_models_iddocument_model__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var _shared_components_button_card_button_card_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      ...
      var _shared_components_centri_centri_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ../../shared/components/centri/centri.component */
      "Nzk7");
      /* harmony import */


      var _shared_components_news_eventi_news_eventi_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ../../shared/components/news-eventi/news-eventi.component */
      "nqF+");

      function HomePage_ion_grid_8_ion_slide_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("clickElement", function HomePage_ion_grid_8_ion_slide_2_Template_app_button_card_clickElement_1_listener($event) {
            ...
            return ctx_r11.onClickButtonCardImpegni($event);
          });
      ...
      function HomePage_ion_grid_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomePage_ion_grid_9_ion_slide_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("clickElement", function HomePage_ion_grid_9_ion_slide_2_Template_app_button_card_clickElement_1_listener($event) {
            ...
            return ctx_r15.onClickButtonCardImpegni($event);
          });
      ...
      function HomePage_div_10_ion_item_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomePage_div_10_ion_slide_3_ion_row_8_ion_col_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("click", function HomePage_div_10_ion_slide_3_ion_row_8_ion_col_1_Template_ion_card_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵrestoreView"](_r25);

            var occupazione_r23 = ctx.$implicit;

            var ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](4);

            return ctx_r24.goToPianificazioneDetail(occupazione_r23);
          });
      ...
      function HomePage_div_10_ion_slide_3_ion_row_8_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var location_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"]().$implicit;
      ...
      function HomePage_div_10_ion_slide_3_ion_row_9_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](0, "ion-row");
        ...
        if (rf & 2) {
          var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](3);
      ...
      function HomePage_div_10_ion_slide_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomePage_div_11_ion_slides_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomePage_div_11_ion_slides_10_ion_slide_1_Template(rf, ctx) {
        if (rf & 1) {
          var _r32 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("click", function HomePage_div_11_ion_slides_10_ion_slide_1_Template_app_button_card_click_1_listener() {
            ...
            var impegno_r30 = ctx.$implicit;

            var ctx_r31 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](3);

            return ctx_r31.onClickImpegnoTrainer(impegno_r30);
          });
        ...
        if (rf & 2) {
          ...
          var ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](3);
      ...
      function HomePage_div_11_ion_slides_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](0, "ion-slides", 17);
        ...
        if (rf & 2) {
          var ctx_r28 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](2);
      ...
      function HomePage_ion_button_18_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("click", function HomePage_ion_button_18_Template_ion_button_click_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵrestoreView"](_r34);

            var ctx_r33 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"]();

            return ctx_r33.showSceltaCentro($event);
          });
      ...
      function HomePage_ion_grid_20_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("clickPrenota", function HomePage_ion_grid_20_Template_app_centri_clickPrenota_3_listener($event) {
            ...
            return ctx_r35.onClickPrenota($event);
          })("clickLocation", function HomePage_ion_grid_20_Template_app_centri_clickLocation_3_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵrestoreView"](_r36);

            var ctx_r37 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"]();

            return ctx_r37.onClickLocation($event);
          });
      ...
      function HomePage_div_21_app_centri_1_Template(rf, ctx) {
        if (rf & 1) {
          var _r41 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](0, "app-centri", 42);

          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("clickPrenota", function HomePage_div_21_app_centri_1_Template_app_centri_clickPrenota_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵrestoreView"](_r41);

            var ctx_r40 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](2);

            return ctx_r40.onClickPrenota($event);
          })("clickLocation", function HomePage_div_21_app_centri_1_Template_app_centri_clickLocation_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵrestoreView"](_r41);

            var ctx_r42 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](2);

            return ctx_r42.onClickLocation($event);
          });
        ...
        if (rf & 2) {
          var locationItem_r39 = ctx.$implicit;

          var ctx_r38 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](2);
      ...
      function HomePage_ion_grid_30_ion_col_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("clickNews", function HomePage_ion_grid_30_ion_col_2_Template_app_news_eventi_clickNews_1_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵrestoreView"](_r46);

            var news_r44 = ctx.$implicit;

            var ctx_r45 = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵnextContext"](2);

            return ctx_r45.onClickNews(news_r44, $event);
          });
      ...
      function HomePage_ion_grid_30_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomePage_ion_grid_31_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵelementStart"](0, "ion-grid", 26);
      ...
      var Geolocation = _capacitor_core__WEBPACK_IMPORTED_MODULE_12__["Plugins"].Geolocation;

      var HomePage = /*#__PURE__*/function () {
        function HomePage(startService, actionSheetController, navController, modalController, docStructureService, toastController) {
          var _this = this;
          ...
          this.toastController = toastController; // Elenco delle Aree

          this.listAree = []; // Elenco delle Location da mostrare

          this.listLocation = []; //Elenco delle prossime attività

          this.myListImpegni = [];
          this.myListImpegniTrainer = [];
          this.listButtonImpegni = []; //Bottoni da mostrare nell'area impegni

          this.listNews = []; //Bottoni da mostrare nella porzione Agenda

          this.agendaCards = [];
          this.listOccupazioni = []; //array di array di occupazioni, divise per locations
          //Mostra o nasconde Area Agenda

          this.showAgenda = false; //Guarda qui
          ...
          this.noNewsCard = src_app_models_newsevento_model__WEBPACK_IMPORTED_MODULE_6__["NewsEvento"].getNoNews(); // Parametri di Configurazione Iniziale Applicazione

          this.startConfigListen = this.startService.startConfig.subscribe(function (element) {
            _this.startConfig = element;
          }); // Sottoscrivo alla ricezione delle Aree

          this.listAreeListen = this.startService.listAree.subscribe(function (aree) {
            _this.listAree = aree.filter(function (objArea) {
              return objArea.APPSHOW;
            }); //quando le aree sono arrivate, se non sono loggato seleziono la più vicina

            if (!_this.userLogged) {
              _this.startService.getNearestArea(_this.listAree).then(function (nearestArea) {
                //trovata l'area, posso passarne l'id al metodo selectarea
                _this.startService.selectAreaByID(nearestArea.ID);
              });
            }
          ...
          this.selectedAreaListen = this.startService.areaSelected.subscribe(function (areaSel) {
            //controllo se nell'array di aree è presente quella selezionata
            if (_this.listAree.includes(areaSel)) {
              //Cambio Area Selezionata
              _this.selectedArea = areaSel;
            } //altrimenti setto come area selezionata la prima disponibile
            else {
                _this.selectedArea = _this.listAree[0];
              } //richiedo le location sulla base della nuova area selezionata


            startService.requestLocation(_this.selectedArea.ID); //Richiesta nuove News

            _this.requestNews(); //Aggiorno l'agenda


            _this.updateAgenda(); // this.richiediAgendaOccupazione();

          }); // QUI POSSO AGGANCIARE EVENTI ALL'ARRIVO DELLE LOCATIONS
          // Sottoscrivo alla ricezione delle Locations

          this.listLocationListen = this.startService.listLocation.subscribe(function (locations) {
            _this.listLocation = locations;

            if (_this.listLocation && _this.listLocation.length > 0) {
              _this.richiediAgendaOccupazione();
            }
          }); //Sottoscrivo all'ascolto di un utente loggato

          this.userLoggedListen = this.startService.utenteLogged.subscribe(function (element) {
            //Recupero l'utente
            _this.userLogged = element; //Aggiorno lista impegni e cerco di visualizzare le card superiori

            _this.updateListImpegni(); //Aggiorno l'agenda
            // this.updateAgenda();
            // this.richiediAgendaOccupazione();

          }); //Sottoscrivo all'ascolto dell'Account

          this.docUtenteListen = this.startService.utente.subscribe(function (element) {
            _this.docUtente = element; //Aggiorno lista impegni e cerco di visualizzare le card superiori
        ...
        _createClass(HomePage, [{
          ...
          value: function requestNews() {
            ...
            if (this.selectedArea) {
              ...
              this.startService.requestNews(this.selectedArea.ID, 3).then(function (listNews) {
                _this2.listNews = listNews;
              });
            }
          }
        }, {
          ...
          key: "createButtonCardImpegni",
          value: function createButtonCardImpegni() {
            var params = new src_app_models_buttoncard_model__WEBPACK_IMPORTED_MODULE_5__["ButtonHomeParams"](); //Preparo i parametri
          ...
          key: "onClickButtonCardImpegni",
          value: function onClickButtonCardImpegni(btn) {
            if (btn) {
          ...
          key: "redirectFromButtonCard",
          value: function redirectFromButtonCard(btn) {
          ...
          key: "onClickShowAllNews",
          value: function onClickShowAllNews() {
          ...
          key: "ngOnInit",
          value: function ngOnInit() {//prova localizzazione
          ...
          key: "onClickfooterButton",
          value: function onClickfooterButton() {
            if (this.userLogged) {
              // Apro lo Storico
              this.openHistory();
            } else {
          ...
          key: "onClickPrenota",
          value: function onClickPrenota(location) {
          ...
          key: "onClickLocation",
          value: function onClickLocation(location) {
          ...
          key: "showSceltaCentro",
          value: function showSceltaCentro(ev) {
          ...
          value: function presentActionSheet() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              ...
              var buttonsArray, singleButton, _iterator, _step, _loop, actionSheet;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      _iterator = _createForOfIteratorHelper(this.listAree);
                        ...
                        _loop = function _loop() {
                          ...
                          singleButton = {
                            ...
                            handler: function handler() {
                              ...
                              _this3.startService.selectAreaByID(iterator.ID);
                            }
                          };
          ...
          key: "btnFooterCaption",
          value: function btnFooterCaption() {
            var retCaption = '';
            var captionAccedi = 'Accedi';
            retCaption = captionAccedi; //Utente Loggato
          ...
          key: "btnFooterIcon",
          value: function btnFooterIcon() {
            var retIcon = '';
            var iconAccedi = 'log-in-outline';
            retIcon = iconAccedi; //Utente Loggato
          ...
          key: "updateListImpegni",
          value: function updateListImpegni() {
            var _this4 = this;

            var reqParam = new src_app_library_models_requestParams_model__WEBPACK_IMPORTED_MODULE_10__["RequestParams"]();
            reqParam.top = 10;
            ...
            if (this.userLogged) {
              if (this.docUtente) {
                ...
                var filterImpegno = new src_app_models_impegno_model__WEBPACK_IMPORTED_MODULE_3__["Impegno"](true);
                filterImpegno.IDUTENTE = this.docUtente.ID;
                filterImpegno.DATAORAINIZIO = new Date(); //Applico una condizione per la dataorainizio
                ...
                this.docStructureService.requestNew(filterImpegno, reqParam).then(function (listImpegni) {
                  _this4.myListImpegni = listImpegni; //Reimposto l'area impegni

                  _this4.createButtonCardImpegni();
                })["catch"](function (error) {
                  _this4.myListImpegni = [];
                  console.log(error);
                });
              } else {
                this.myListImpegni = []; //Reimposto l'area impegni
          ...
          key: "onClickShowAgenda",
          value: function onClickShowAgenda() {
          ...
          value: function updateAgenda() {
            var richiediOccupazioni = false;
            var richiediMieiCorsi = false;
            ...
            if (this.selectedArea && this.selectedArea.ID) {
              ...
              } else if (richiediOccupazioni) {// this.richiediAgendaOccupazione();
              } else {
                //Nascono l'agenda che non serve
                this.showAgenda = false; //Elimino l'agenda
          ...
          key: "richiediAgendaOccupazione",
          value: function richiediAgendaOccupazione() {
            var _this5 = this;

            if (this.listLocation && this.listLocation.length > 0) {
              var idArea = this.selectedArea.ID; // this.showAgenda = true;

              this.listLocation.forEach(function (elLocation) {
                _this5.startService.requestOccupazioni(idArea, elLocation.ID, 4, undefined, new Date()).then(function (listOccupazioni) {
          ...
          key: "richiediAgendaTrainer",
          value: function richiediAgendaTrainer() {
            var _this6 = this;

            //qui stò richiedendo gli impegni che riguardano l'utente in quanto "collaboratore"
            this.startService.requestImpegniTrainer(this.docUtente.ID, new Date()).then(function (result) {
              _this6.myListImpegniTrainer = result;
            })["catch"](function (error) {
              console.log(error);
            });
          } //#endregion
          ...
          key: "getButtonCardTrainer",
          value: function getButtonCardTrainer(pianificazioneElem) {
            if (pianificazioneElem) {
              ...
              var btnCard = new src_app_models_buttoncard_model__WEBPACK_IMPORTED_MODULE_5__["ButtonCard"]();
          ...
          key: "getButtonEmptyOccupazione",
          value: function getButtonEmptyOccupazione() {
            var btnCard = new src_app_models_buttoncard_model__WEBPACK_IMPORTED_MODULE_5__["ButtonCard"]();
          ...
          key: "onClickImpegnoTrainer",
          value: function onClickImpegnoTrainer(pianificazioneElem) {
          ...
          value: function onTest() {
            var componente = undefined;
            var componentProps = undefined;
            var idArea = this.startService.areaSelectedValue.ID;
            var path = '/agenda-custode/' + idArea;
          ...
          key: "goToPianificazioneDetail",
          value: function goToPianificazioneDetail(docOccupazione) {
      ...
      HomePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({
        ...
        template: function HomePage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("click", function HomePage_Template_ion_button_click_27_listener() {
              return ctx.onClickShowAllNews();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵlistener"]("click", function HomePage_Template_ion_button_click_33_listener() {
              return ctx.onClickfooterButton();
            });
