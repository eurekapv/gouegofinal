(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sportlevels-sportlevels-module"], {
    ...
    /***/
    function H2v(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SportlevelsPageRoutingModule", function () {
        return SportlevelsPageRoutingModule;
      });
      /* harmony import */
      ...
      var _sportlevels_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./sportlevels.page */
      "boUX");
      /* harmony import */
      ...
      var SportlevelsPageRoutingModule = function SportlevelsPageRoutingModule() {
        _classCallCheck(this, SportlevelsPageRoutingModule);
      };

      SportlevelsPageRoutingModule.ɵfac = function SportlevelsPageRoutingModule_Factory(t) {
        return new (t || SportlevelsPageRoutingModule)();
      };

      SportlevelsPageRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: SportlevelsPageRoutingModule
      });
      SportlevelsPageRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](SportlevelsPageRoutingModule, {
    ...
    /***/
    function boUX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SportlevelsPage", function () {
        return SportlevelsPage;
      });
      /* harmony import */
      ...
      function SportlevelsPage_div_9_ion_col_10_img_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelement"](0, "img", 22);
        }

        if (rf & 2) {
          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](3);
      ...
      function SportlevelsPage_div_9_ion_col_10_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SportlevelsPage_div_9_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](7, " I tuoi livelli verranno utilizzati per determinare i corsi pi\xF9 adatti a te. ");
      ...
      function SportlevelsPage_div_10_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SportlevelsPage = /*#__PURE__*/function () {
        function SportlevelsPage(startService, socialSharing) {
          var _this = this;

          _classCallCheck(this, SportlevelsPage);

          this.startService = startService;
          this.socialSharing = socialSharing;
          this.showLogoGruppo = false; //Attendo la ricezione dei dati Utente

          this.utenteListener = this.startService.utente.subscribe(function (data) {
            _this.utente = data;
          }); //Recupero il logo del gruppo

          this.startService.requestBase64Image(src_app_models_valuelist_model__WEBPACK_IMPORTED_MODULE_2__["TipoPrivateImage"].logo).then(function (b64Image) {
            //Arriva in Base64
            _this.logoGruppoBase64 = b64Image;

            if (_this.logoGruppoBase64.length != 0) {
              _this.showLogoGruppo = true;
            } else {
              _this.showLogoGruppo = false;
            }
        ...
        _createClass(SportlevelsPage, [{
          ...
          key: "onShare",
          value: function onShare(sportLevelPrimaryKey) {
            var method = 'SVG';
            var options = {
              width: 350,
              height: 600
            ...
            if (!this.startService.isDesktop || this.startService.isDesktop) {
              //recupero il livello
              var docLivello;
              docLivello = this.utente.UTENTILIVELLI.find(function (elem) {
                return elem.ID == sportLevelPrimaryKey;
              });

              if (docLivello) {
                //compongo il messaggio
                messaggio = this.utente.NOME + ' ha ottenuto il livello ' + docLivello.DESCRLIVELLO + ' a ' + docLivello.DESCRSPORT + '! Complimenti!!'; //recupero l'immagine della card

                var DOMCard = document.getElementById(sportLevelPrimaryKey);
              }
            }
          }
        }, {
      ...
      SportlevelsPage.ɵfac = function SportlevelsPage_Factory(t) {
        return new (t || SportlevelsPage)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](src_app_services_start_service__WEBPACK_IMPORTED_MODULE_0__["StartService"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_1__["SocialSharing"]));
      };

      SportlevelsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        type: SportlevelsPage,
        selectors: [["app-sportlevels"]],
        decls: 11,
        vars: 2,
        consts: [["color", "primary"], ["slot", "start"], ["defaultHref", "/account"], ["slot", "fixed", 3, "ionRefresh"], ["class", "ion-no-padding", 4, "ngIf"], ["class", "nofind-cnt", 4, "ngIf"], [1, "ion-no-padding"], [2, "height", "1vh"], [1, "info"], ["color", "light", "lines", "none"], [1, "ion-text-wrap"], ["name", "information-circle-outline", "color", "primary"], ["sizeXs", "10", "offsetXs", "1", "sizeSm", "6", "offsetSm", "0", "sizeMd", "4", "sizeLg", "3", 3, "id", 4, "ngFor", "ngForOf"], ["sizeXs", "10", "offsetXs", "1", "sizeSm", "6", "offsetSm", "0", "sizeMd", "4", "sizeLg", "3", 3, "id"], [1, "card-livello", 3, "button"], [1, "ion-no-padding", "ion-text-center"], ["id", "img-logo", 3, "src", 4, "ngIf"], [1, "ion-text-center"], ["size", "12", 1, "ion-text-center"], ["src", "/assets/trophy2.png"], ["size", "12"], [1, "level-label"], ["id", "img-logo", 3, "src"], [1, "nofind-cnt"]],
        template: function SportlevelsPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("ionRefresh", function SportlevelsPage_Template_ion_refresher_ionRefresh_7_listener($event) {
    ...
    /***/
    function mA1B(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SportlevelsPageModule", function () {
        return SportlevelsPageModule;
      });
      /* harmony import */
      ...
      var _sportlevels_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./sportlevels-routing.module */
      "H2v/");
      /* harmony import */


      var _sportlevels_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./sportlevels.page */
      "boUX");
      /* harmony import */
      ...
      var SportlevelsPageModule = function SportlevelsPageModule() {
        _classCallCheck(this, SportlevelsPageModule);
      };

      SportlevelsPageModule.ɵfac = function SportlevelsPageModule_Factory(t) {
        return new (t || SportlevelsPageModule)();
      };

      SportlevelsPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineNgModule"]({
        type: SportlevelsPageModule
      });
      SportlevelsPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _sportlevels_routing_module__WEBPACK_IMPORTED_MODULE_3__["SportlevelsPageRoutingModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](SportlevelsPageModule, {
          declarations: [_sportlevels_page__WEBPACK_IMPORTED_MODULE_4__["SportlevelsPage"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonicModule"], _sportlevels_routing_module__WEBPACK_IMPORTED_MODULE_3__["SportlevelsPageRoutingModule"]]
        });
      })();
      /***/
...
//# sourceMappingURL=sportlevels-sportlevels-module-es5.js.map