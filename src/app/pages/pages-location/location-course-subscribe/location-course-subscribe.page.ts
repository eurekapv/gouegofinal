...
import { PageType, PaymentChannel, PaymentMode, SettorePagamentiAttivita, TipoCorso, TipoRigoIncasso, TipoScadenza, ZOrderIncasso } from 'src/app/models/valuelist.model';
