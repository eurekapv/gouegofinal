...
import { IonAccordionGroup, LoadingController, NavController } from '@ionic/angular';
...
@Component({
  ...
  templateUrl: './list-club-cards.page.html',
  styleUrls: ['./list-club-cards.page.scss'],
})
export class ListClubCardsPage implements OnInit {
